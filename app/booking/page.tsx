    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-xl">
        <div className="relative z-[9999] pointer-events-auto">
          ...
          <select className="w-full border rounded px-3 py-2 relative z-50 bg-white cursor-pointer" value={form.service_id} onChange={e=>setForm({...form, service_id: e.target.value})} disabled={!categoryId}>
